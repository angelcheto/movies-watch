<section id="game-details">
    ...
    <div className="info-section">
        <div className="game-header">
            <img className="game-img" src="images/MineCraft.png" alt="Game Cover" />
            <h1>Bright</h1>
    ...
    {/* Bonus */}
    {/* Add Comment (Only for logged-in users, who are not the creators of the current game) */}
    <article className="create-comment">
        <label htmlFor="new-comment">Add new comment:</label>
        <form className="form">
            <textarea id="new-comment" name="comment" placeholder="Comment......"></textarea>
